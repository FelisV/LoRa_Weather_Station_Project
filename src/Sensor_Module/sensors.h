...
public:
    ...
    /**
     * @brief Get the status of the battery from battery_Present flag
     * @return It returns the value of the battery_Present flag
     */
    bool get_Battery_Present();
...
private:
    ...
    // Battery variables
    bool battery_Present; // Flag to indicate if the battery is present
